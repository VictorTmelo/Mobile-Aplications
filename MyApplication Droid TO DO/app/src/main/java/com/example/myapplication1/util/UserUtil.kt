...
object UserUtil {
    ...
    userList.add(User(1, "Victor Torres", "victor_tmeloo@edu.unifor.br", "1820331", listOf<Category>()))
    ...
    fun addUser(nome:String, email: String, senha:String){
        ...
        userList.add(User(userList.size + 1,nome, email, senha, listOf<Category>()))
